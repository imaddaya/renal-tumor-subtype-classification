...
CM_PNG = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_Macenko/results/ResNet18_MIL_Macenko_multisample_confusion_matrix.png"
PROBS_PNG = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_Macenko/results/ResNet18_MIL_Macenko_multisample_probabilities.png"
CLASS_ERROR_PNG = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_Macenko/results/ResNet18_MIL_Macenko_multisample_class_error_rates.png"
AVG_CLASS_ERROR_PNG = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_Macenko/results/ResNet18_MIL_Macenko_multisample_average_class_error_rates.png"
PER_RUN_PNG = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_Macenko/results/ResNet18_MIL_Macenko_multisample_per_run_predictions.png"
...
ax.set(
    ...
    ylabel="True label",
    title="ResNet18 + MIL + Macenko Multi-Sample Confusion Matrix"
)
...
plt.title("ResNet18 + MIL + Macenko Multi-Sample Final Class Error Rates", pad=20)
...
plt.title("ResNet18 + MIL + Macenko Multi-Sample Average Class Error Rates Across Runs", pad=20)
...
plt.title("ResNet18 + MIL + Macenko Multi-Sample Averaged Probabilities per WSI", pad=20)
...
plt.title("ResNet18 + MIL + Macenko Per-Run Predictions (10 Test-Time Sampling Passes)", pad=20)
