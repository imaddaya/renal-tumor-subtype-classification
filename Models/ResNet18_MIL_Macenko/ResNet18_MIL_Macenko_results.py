...
ACC_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_Macenko/results/ResNet18_MIL_Macenko_accuracy_curve.png"
LOSS_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_Macenko/results/ResNet18_MIL_Macenko_loss_curve.png"
CM_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_Macenko/results/ResNet18_MIL_Macenko_confusion_matrix.png"
REPORT_TABLE_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_Macenko/results/ResNet18_MIL_Macenko_classification_report_table.png"
HISTORY_TABLE_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_Macenko/results/ResNet18_MIL_Macenko_history_table.png"
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("ResNet18 + Attention MIL + Macenko Accuracy Curve")
plt.xticks(df["epoch"])
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("ResNet18 + Attention MIL + Macenko Loss Curve")
plt.xticks(df["epoch"])
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.title("ResNet18 + Attention MIL + Macenko Confusion Matrix")
plt.tight_layout()
plt.savefig(CM_PLOT)
plt.close()
...
if report_rows:
    ...
    table.scale(1.2, 1.5)
    plt.title("ResNet18 + Attention MIL + Macenko Classification Report", pad=20)
    plt.tight_layout()
...
table.scale(1.2, 1.3)
plt.title("ResNet18 + Attention MIL + Macenko Training History", pad=20)
plt.tight_layout()
