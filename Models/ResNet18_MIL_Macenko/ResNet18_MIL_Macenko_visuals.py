...
FIXED_REPORT_TXT = FIXED_TEST_DIR / "ResNet18_MIL_Macenko_report.txt"
FIXED_CM_CSV = FIXED_TEST_DIR / "ResNet18_MIL_Macenko_confusion_matrix.csv"
FIXED_CLASS_ERROR_CSV = FIXED_TEST_DIR / "ResNet18_MIL_Macenko_class_error_rates.csv"

MULTI_CM_CSV = MULTISAMPLE_DIR / "ResNet18_MIL_Macenko_multisample_confusion_matrix.csv"

COMBINED_GRAPH_PNG = VISUALS_DIR / "ResNet18_MIL_Macenko_training_overview.png"
REPORT_TABLE_PNG = VISUALS_DIR / "ResNet18_MIL_Macenko_classification_report_table.png"
DETAILED_ERROR_TABLE_PNG = VISUALS_DIR / "ResNet18_MIL_Macenko_detailed_error_table.png"
FIXED_CM_PNG = VISUALS_DIR / "ResNet18_MIL_Macenko_fixed_confusion_matrix.png"
MULTI_CM_PNG = VISUALS_DIR / "ResNet18_MIL_Macenko_multisample_confusion_matrix.png"
SUMMARY_TABLE_PNG = VISUALS_DIR / "ResNet18_MIL_Macenko_summary_table.png"
...
ax2.set_ylabel("Loss")
ax1.set_title("ResNet18 + MIL + Macenko Training Overview")
...
save_table_png(
    report_table_df,
    "ResNet18 + MIL + Macenko Fixed Test Classification Report",
    REPORT_TABLE_PNG,
    font_size=10,
    x_scale=1.2,
    y_scale=1.5
...
save_table_png(
    detailed_error_df,
    "ResNet18 + MIL + Macenko Fixed Test Detailed Prediction/Error Table",
...
plot_confusion_matrix(
    fixed_cm,
    fixed_labels,
    "ResNet18 + MIL + Macenko Fixed Test Confusion Matrix",
    FIXED_CM_PNG
)
...
plot_confusion_matrix(
    multi_cm,
    multi_labels,
    "ResNet18 + MIL + Macenko Multi-Sample Confusion Matrix",
    MULTI_CM_PNG
)
