...
FIXED_REPORT_TXT = FIXED_TEST_DIR / "ResNet18_MIL_report.txt"
FIXED_CM_CSV = FIXED_TEST_DIR / "ResNet18_MIL_confusion_matrix.csv"
FIXED_CLASS_ERROR_CSV = FIXED_TEST_DIR / "ResNet18_MIL_class_error_rates.csv"

MULTI_CM_CSV = MULTISAMPLE_DIR / "ResNet18_MIL_multisample_confusion_matrix.csv"

COMBINED_GRAPH_PNG = VISUALS_DIR / "ResNet18_MIL_training_overview.png"
REPORT_TABLE_PNG = VISUALS_DIR / "ResNet18_MIL_classification_report_table.png"
DETAILED_ERROR_TABLE_PNG = VISUALS_DIR / "ResNet18_MIL_detailed_error_table.png"
FIXED_CM_PNG = VISUALS_DIR / "ResNet18_MIL_fixed_confusion_matrix.png"
MULTI_CM_PNG = VISUALS_DIR / "ResNet18_MIL_multisample_confusion_matrix.png"
SUMMARY_TABLE_PNG = VISUALS_DIR / "ResNet18_MIL_summary_table.png"
...
ax2.set_ylabel("Loss")
ax1.set_title("ResNet18 + MIL Training Overview")
...
save_table_png(
    report_table_df,
    "ResNet18 + MIL Fixed Test Classification Report",
    REPORT_TABLE_PNG,
    font_size=10,
    x_scale=1.2,
    y_scale=1.5
...
save_table_png(
    detailed_error_df,
    "ResNet18 + MIL Fixed Test Detailed Prediction/Error Table",
...
plot_confusion_matrix(
    fixed_cm,
    fixed_labels,
    "ResNet18 + MIL Fixed Test Confusion Matrix",
    FIXED_CM_PNG
)
...
plot_confusion_matrix(
    multi_cm,
    multi_labels,
    "ResNet18 + MIL Multi-Sample Confusion Matrix",
    MULTI_CM_PNG
)
