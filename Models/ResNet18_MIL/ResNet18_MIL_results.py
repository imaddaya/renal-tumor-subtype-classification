...
HISTORY_CSV = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL/results/ResNet18_MIL_history.csv"
REPORT_TXT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL/results/ResNet18_MIL_report.txt"

ACC_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL/results/ResNet18_MIL_accuracy_curve.png"
LOSS_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL/results/ResNet18_MIL_loss_curve.png"
CM_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL/results/ResNet18_MIL_confusion_matrix.png"
REPORT_TABLE_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL/results/ResNet18_MIL_classification_report_table.png"
HISTORY_TABLE_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL/results/ResNet18_MIL_history_table.png"
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("ResNet18 + MIL Accuracy Curve")
plt.xticks(df["epoch"])
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("ResNet18 + MIL Loss Curve")
plt.xticks(df["epoch"])
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.title("ResNet18 + MIL Confusion Matrix")
plt.tight_layout()
plt.savefig(CM_PLOT)
plt.close()
...
if report_rows:
    ...
    table.scale(1.2, 1.5)
    plt.title("ResNet18 + MIL Classification Report", pad=20)
    plt.tight_layout()
...
table.scale(1.2, 1.3)
plt.title("ResNet18 + MIL Training History", pad=20)
plt.tight_layout()
