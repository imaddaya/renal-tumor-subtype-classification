...
HISTORY_CSV = "/home/hpdeadman/Grad_Project/Models/ResNet18_VisionMamba_KAN/results/ResNet18_VisionMamba_KAN_history.csv"
REPORT_TXT = "/home/hpdeadman/Grad_Project/Models/ResNet18_VisionMamba_KAN/results/ResNet18_VisionMamba_KAN_report.txt"

ACC_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_VisionMamba_KAN/results/ResNet18_VisionMamba_KAN_accuracy_curve.png"
LOSS_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_VisionMamba_KAN/results/ResNet18_VisionMamba_KAN_loss_curve.png"
CM_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_VisionMamba_KAN/results/ResNet18_VisionMamba_KAN_confusion_matrix.png"
REPORT_TABLE_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_VisionMamba_KAN/results/ResNet18_VisionMamba_KAN_classification_report_table.png"
HISTORY_TABLE_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_VisionMamba_KAN/results/ResNet18_VisionMamba_KAN_history_table.png"
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("ResNet18 + Vision Mamba + KAN Accuracy Curve")
plt.xticks(df["epoch"])
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("ResNet18 + Vision Mamba + KAN Loss Curve")
plt.xticks(df["epoch"])
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.title("ResNet18 + Vision Mamba + KAN Confusion Matrix")
plt.tight_layout()
plt.savefig(CM_PLOT)
plt.close()
...
if report_rows:
    ...
    table.scale(1.2, 1.5)
    plt.title("ResNet18 + Vision Mamba + KAN Classification Report", pad=20)
    plt.tight_layout()
...
table.scale(1.2, 1.3)
plt.title("ResNet18 + Vision Mamba + KAN Training History", pad=20)
plt.tight_layout()
