...
MODEL_PATH = "/home/hpdeadman/Grad_Project/Models/ResNet18_VisionMamba_KAN/results/ResNet18_VisionMamba_KAN_model.pth"
...
REPORT_TXT = "/home/hpdeadman/Grad_Project/Models/ResNet18_VisionMamba_KAN/results/ResNet18_VisionMamba_KAN_multisample_report.txt"
...
# -------------------------
# Model: ResNet18 + Vision Mamba + KAN
# -------------------------
class ResNet18VisionMambaKANModel(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.kan(slide_feats)
        return out

model = ResNet18VisionMambaKANModel(num_classes=NUM_CLASSES).to(DEVICE)
