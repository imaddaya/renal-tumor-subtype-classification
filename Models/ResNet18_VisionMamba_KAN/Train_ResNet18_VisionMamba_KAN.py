...
REPORT_TXT = FIXED_TEST_DIR / "ResNet18_VisionMamba_KAN_report.txt"
CM_CSV = FIXED_TEST_DIR / "ResNet18_VisionMamba_KAN_confusion_matrix.csv"
PROBS_CSV = FIXED_TEST_DIR / "ResNet18_VisionMamba_KAN_probabilities.csv"
CLASS_ERROR_CSV = FIXED_TEST_DIR / "ResNet18_VisionMamba_KAN_class_error_rates.csv"
...
class ResNet18VisionMambaKANModel(nn.Module):
    ...
    def forward(self, x):
        ...
        seq_out = self.mamba(feats)       # [B, N, feat_dim]
        slide_feats = seq_out.mean(dim=1) # [B, feat_dim]

        out = self.kan(slide_feats)       # [B, num_classes]
        return out
