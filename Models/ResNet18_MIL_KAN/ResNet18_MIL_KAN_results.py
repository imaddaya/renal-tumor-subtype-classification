...
ACC_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_KAN/results/ResNet18_MIL_KAN_accuracy_curve.png"
LOSS_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_KAN/results/ResNet18_MIL_KAN_loss_curve.png"
CM_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_KAN/results/ResNet18_MIL_KAN_confusion_matrix.png"
REPORT_TABLE_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_KAN/results/ResNet18_MIL_KAN_classification_report_table.png"
HISTORY_TABLE_PLOT = "/home/hpdeadman/Grad_Project/Models/ResNet18_MIL_KAN/results/ResNet18_MIL_KAN_history_table.png"
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("ResNet18 + Attention MIL + KAN Accuracy Curve")
plt.xticks(df["epoch"])
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("ResNet18 + Attention MIL + KAN Loss Curve")
plt.xticks(df["epoch"])
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.title("ResNet18 + Attention MIL + KAN Confusion Matrix")
plt.tight_layout()
plt.savefig(CM_PLOT)
plt.close()
...
if report_rows:
    ...
    table.scale(1.2, 1.5)
    plt.title("ResNet18 + Attention MIL + KAN Classification Report", pad=20)
    plt.tight_layout()
...
table.scale(1.2, 1.3)
plt.title("ResNet18 + Attention MIL + KAN Training History", pad=20)
plt.tight_layout()
